...
usage: export_cs_rest_userstats.py
...
if __name__ == "__main__":
    ...
    from appraise.cs_rest.models import HIT, Project
    from appraise.cs_rest.views import _identify_groups_for_user
    
    # Compute user statistics for all users.
    user_stats = []
    cs_rest = Group.objects.get(name='CS_REST')
    users = cs_rest.user_set.all()
