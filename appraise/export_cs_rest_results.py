...
usage: export_cs_rest_results.py

Exports CS_REST results for all language pairs, in CSV WMT format.
...
if __name__ == "__main__":
    ...
    from appraise.cs_rest.models import RankingResult, Project
